...
RocketChat.settings.addGroup 'Accounts', ->
	...
	@section 'Registration', ->
		...
		@add 'Invitation_Required', false, { type: 'boolean', public: true }
		@add 'Local_Login_Restricted', false, { type: 'boolean', public: true }
...
RocketChat.settings.addGroup 'API', ->
	...
	@add 'Kadira_App_Id', '', { type: 'string' }
	@add 'Kadira_App_Secret', '', {type: 'string' }
