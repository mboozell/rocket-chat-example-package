...
RocketChat.settings.add 'Invitation_Required', true, { type: 'boolean', group: 'Accounts', public: true, section: 'Registration' }
...
RocketChat.settings.add 'Layout_Sidenav_Footer', '<a href="https://github.com/jpopesculian/Rocket.Chat" class="logo" target="_blank"> <img src="/images/logo/logo.svg?v=3" /> <small><i class="icon-github-circled"></i> Fork it on github</small> </a>', { type: 'string', group: 'Layout', public: true, i18nDescription: 'Layout_Sidenav_Footer_description' }
